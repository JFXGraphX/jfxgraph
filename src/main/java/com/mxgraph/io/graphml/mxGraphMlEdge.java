...
public class mxGraphMlEdge {
	...
	public mxGraphMlEdge(Element edgeElement) {
		...
		this.edgeSource = edgeElement
				.getAttribute(mxGraphMlConstants.EDGE_SOURCE);
		this.edgeSourcePort = edgeElement
				.getAttribute(mxGraphMlConstants.EDGE_SOURCE_PORT);
		this.edgeTarget = edgeElement
				.getAttribute(mxGraphMlConstants.EDGE_TARGET);
	...
	public Element generateElement(Document document) {
		...
		if (!edgeSourcePort.equals("")) {
			edge.setAttribute(mxGraphMlConstants.EDGE_SOURCE_PORT,
					edgeSourcePort);
		}

		if (!edgeTargetPort.equals("")) {
			edge.setAttribute(mxGraphMlConstants.EDGE_TARGET_PORT,
					edgeTargetPort);
		}
