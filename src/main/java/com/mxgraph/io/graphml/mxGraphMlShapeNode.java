...
public class mxGraphMlShapeNode {
	 ...
	 *            Node's style.
	 */
	public mxGraphMlShapeNode(String dataHeight, String dataWidth,
			String dataX, String dataY, String dataStyle) {
	...
	public mxGraphMlShapeNode(Element shapeNodeElement) {
		...
		this.dataHeight = geometryElement
				.getAttribute(mxGraphMlConstants.HEIGHT);
	...
	public Element generateElement(Document document) {
		Element dataShape = document.createElementNS(
				mxGraphMlConstants.JGRAPH_URL, mxGraphMlConstants.JGRAPH
						+ mxGraphMlConstants.SHAPENODE);
		...
		if (!this.dataStyle.equals("")) {
			...
			dataShapeStyle.setAttribute(mxGraphMlConstants.PROPERTIES,
					dataStyle);
