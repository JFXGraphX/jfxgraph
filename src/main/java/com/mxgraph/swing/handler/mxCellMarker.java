...
public class mxCellMarker extends JComponent {
	...
	/**
	 * Specifies if the highlights should appear on top of everything else in
	 * the overlay pane. Default is false.
	 */
	 ...
	 * highlight. The area around the center of the cell to be marked is used as
	 * the hotspot. Possible values are between 0 and 1. Default is
	...
	/**
	 * Uses getCell, getMarkedState and intersects to return the state for the
	 * given event.
	 */
