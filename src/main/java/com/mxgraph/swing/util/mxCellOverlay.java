...
public class mxCellOverlay extends JComponent implements mxICellOverlay {
	...
	/**
	 * Holds the horizontal alignment for the overlay. Default is ALIGN_RIGHT.
	 * For edges, the overlay always appears in the center of the edge.
	 */
	protected Object align = mxConstants.ALIGN_RIGHT;

	/**
	 * Holds the vertical alignment for the overlay. Default is bottom. For
	 ...
	 * distance from the origin to the point defined by the alignment. Default
	 * is 0.5.
	 */
